...
export class NotificationService {
    ...
    async getNotificationList(user: User): Promise<Notification[]> {
        return this.notificationRepository.find({ user_id: user.id });
    }
    ...
    async checkReadNotification(user: User, notificationId: number) {
    ...
    private async getNotificationById(notificationId: number): Promise<Notification> {
    ...
    private async isNotificationOwner(user: User, notification: Notification): Promise<boolean> {
